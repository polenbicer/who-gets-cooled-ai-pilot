  ...
  Istanbul: {
    ...
    districts: [
      ...
      },
      {
        ...
        lat: 41.0182,
        lng: 28.9437,
        description: "Historic peninsula with low canopy, intense tourist/transit load and vulnerable aging stock.",
        heat: 93,
        poverty: 69,
        elderly: 44,
        housing: 86,
      ...
      },
      {
        ...
        lat: 40.9910,
        lng: 29.0270,
        description: "High coastal elderly demographics, dense mid-rise apartments and rising nighttime surface heat.",
        heat: 78,
        poverty: 48,
        elderly: 43,
        housing: 74,
      ...
      },
      {
        ...
        lat: 41.1680,
        lng: 29.0550,
        description: "Forested northern reservoir perimeter with low surface temperatures and high tree canopy.",
        heat: 42,
        poverty: 32,
        elderly: 25,
        housing: 38,
    ...
    districts: [
      {
        ...
        lat: 50.8546,
        lng: 4.3340,
        description: "Dense housing along the canal corridor with severe lack of tree canopy and high social vulnerability.",
        heat: 91,
        poverty: 86,
        elderly: 34,
        housing: 89,
      ...
      },
      {
        ...
        lat: 50.8385,
        lng: 4.3468,
        description: "Historic central core with heavy impervious surfaces and low-income social housing towers.",
        heat: 88,
        poverty: 79,
        elderly: 42,
        housing: 76,
      ...
      },
      {
        ...
        lat: 50.8500,
        lng: 4.3700,
        description: "The most densely populated municipality in Belgium with extreme urban heat retention.",
        heat: 90,
        poverty: 86,
        elderly: 29,
        housing: 81,
      ...
      },
      {
        ...
        lat: 50.8242,
        lng: 4.3601,
        description: "Dynamic university & residential district; dense pavement in Flagey contrasts with green ponds.",
        heat: 79,
        poverty: 64,
        elderly: 39,
        housing: 77,
      ...
      },
      {
        ...
        lat: 50.8200,
        lng: 4.3580,
        description: "Affluent residential neighborhood with high private courtyard vegetation and lower heat risk.",
        heat: 58,
        poverty: 32,
        elderly: 28,
        housing: 50,
    ...
    districts: [
      {
        ...
        lat: 52.3680,
        lng: 4.8100,
        description: "Post-war residential blocks with wide paved plazas and high social energy vulnerability.",
        heat: 89,
        poverty: 78,
        elderly: 38,
        housing: 84,
      ...
      },
      {
        ...
        lat: 52.3145,
        lng: 4.9542,
        description: "High-rise social housing clusters near transit nodes; critical cooling shelter demand.",
        heat: 86,
        poverty: 73,
        elderly: 35,
        housing: 80,
      ...
      },
      {
        ...
        lat: 52.3650,
        lng: 4.9380,
        description: "Dense 19th-century fabric in East Amsterdam with high elderly isolation rates.",
        heat: 76,
        poverty: 74,
        elderly: 69,
        housing: 63,
      ...
      },
      {
        ...
        lat: 52.3950,
        lng: 4.9100,
        description: "Rapidly transforming post-industrial waterfront with uneven access to cooling tree buffers.",
        heat: 72,
        poverty: 55,
        elderly: 40,
        housing: 68,
      ...
      },
      {
        ...
        lat: 52.3380,
        lng: 4.8720,
        description: "Affluent district with wide avenues, high tree density, and modern insulated building infrastructure.",
        heat: 42,
        poverty: 25,
        elderly: 47,
        housing: 46,
    ...
    districts: [
      {
        ...
        lat: 38.4189,
        lng: 27.1287,
        description: "Dense commercial and historic waterfront core with heavy asphalt paving and heat trapping.",
        heat: 94,
        poverty: 68,
        elderly: 61,
        housing: 72,
      ...
      },
      {
        ...
        lat: 38.3850,
        lng: 27.1750,
        description: "Fast-growing hillside district with dense apartment corridors and severe daytime heat index.",
        heat: 94,
        poverty: 78,
        elderly: 34,
        housing: 87,
      ...
      },
      {
        ...
        lat: 38.3750,
        lng: 27.1250,
        description: "High residential density, informal urban expansions and low access to shaded public plazas.",
        heat: 92,
        poverty: 81,
        elderly: 39,
        housing: 86,
      ...
      },
      {
        ...
        lat: 38.4650,
        lng: 27.2180,
        description: "Inland valley basin with high daytime thermal load surrounding university and industrial zones.",
        heat: 81,
        poverty: 58,
        elderly: 35,
        housing: 74,
      ...
      },
      {
        ...
        lat: 38.4590,
        lng: 27.1100,
        description: "Coastal waterfront district with cooling bay breeze but large isolated elderly populations.",
        heat: 66,
        poverty: 43,
        elderly: 46,
        housing: 63,
      ...
      },
      {
        ...
        lat: 38.3220,
        lng: 26.7650,
        description: "Peripheral coastal green corridor with low density, olive groves and strong natural ventilation.",
        heat: 39,
        poverty: 29,
        elderly: 42,
        housing: 41,
  ...
  1: [
    {
      ...
      icon: "💧",
      body: "Convert libraries and municipal gyms into free climate-controlled respite hubs in vulnerable sectors.",
    ...
    },
    {
      ...
      icon: "❄️",
      body: "Subsidize electricity bills directly for low-income residents running cooling appliances during the spike.",
    ...
    },
    {
      ...
      icon: "🌳",
      body: "Redirect municipal workforces to install instant shade sails, cool pavements, and tree pits in hotspots.",
    ...
    },
    {
      ...
      icon: "🧊",
      body: "Keep municipal reserves untouched and rely strictly on existing routine emergency dispatch services.",
  ...
  4: [
    {
      ...
      icon: "⚖️",
      body: "Launch an independent algorithmic audit and publish the priority training weights publicly before the next run.",
    ...
    },
    {
      ...
      icon: "📊",
      body: "Invest in ground-level sensor arrays and community participatory reporting in overlooked informal areas.",
    ...
    },
    {
      ...
      icon: "🤖",
      body: "AI is generally right. Keep the model parameters unchanged to preserve fiscal capacity for next quarter.",
    ...
    },
    {
      ...
      icon: "📣",
      body: "Hold a press conference and shift algorithmic accountability strictly to the external technology contractor.",
    ...
    },
    {
      ...
      icon: "👥",
      body: "Create a citizen jury to co-decide automated cooling funds alongside municipal engineers.",
...
function getChoicesForTurn(turn: number): Choice[] {
  ...
  return [
    ...
    },
    {
      ...
      effects: "Justice +16 · Approval +10 · Developers −12",
      cost: 8,
...
export default function MayorGamePage() {
  ...
  // Leaflet Satellite iframe generator
...
<head>
  ...
  <style>
    body, html { margin:0; padding:0; height:100%; width:100%; background:#0b1118; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
...
<body>
  <div id="map"></div>
  <script>
    const map = L.map('map', { zoomControl: false, attributionControl: false }).setView([${cityObj.center[0]}, ${cityObj.center[1]}], ${cityObj.zoom});
    ...
    window.addEventListener('message', (e) => {
      if (e.data && e.data.type === 'SET_VIEW') {
  ...
  return (
    <div className="min-h-screen bg-[#060a0f] text-slate-100 font-sans antialiased select-none flex flex-col justify-between overflow-x-hidden">
      ...
      <div className="flex-1 max-w-[1700px] w-full mx-auto p-3 md:p-4 grid grid-cols-1 lg:grid-cols-12 gap-3.5 items-start">
        ...
        {/* LEFT COLUMN: CITY SELECTOR & PULSE / STAKEHOLDER */}
        ...
        {/* MIDDLE COLUMN: LEAFLET SATELLITE INTERACTIVE MAP */}
        <div className="lg:col-span-6 relative">
          <div className="relative h-[620px] rounded-3xl overflow-hidden border border-slate-800 shadow-2xl bg-[#090e15]">
            ...
            <div className="absolute top-4 right-4 z-20 flex flex-col gap-1.5">
              <button className="size-8 rounded-lg bg-slate-950/80 border border-slate-800 text-slate-300 hover:text-white flex items-center justify-center">
