  ...
  return (
    <main className="min-h-screen bg-[#fafaf9] text-slate-900 font-sans selection:bg-slate-200">
      ...
      {activeTab === 'dashboard' ? (
        ...
        /* MAYOR GAME (WHO GETS COOLED?) FULL SCREEN ENGINE */
        <div>
          {gameScreen === 'intro' ? (
            <div className="min-h-[85vh] bg-[#0d1117] text-white flex items-center px-6 py-12 rounded-3xl mx-4 my-6">
            ...
            <div className="min-h-[85vh] bg-[#0d1117] px-5 py-10 text-white rounded-3xl mx-4 my-6">
              <div className="mx-auto max-w-5xl">
                <div className={`rounded-3xl border p-8 md:p-12 ${end.type === 'WIN' ? 'border-orange-400/20 bg-orange-400/[.04]' : 'border-red-400/20 bg-red-400/[.04]'}`}>
                  ...
                  <button 
                    onClick={resetGame} 
                    className="mt-8 inline-flex items-center gap-2 rounded-xl bg-[#c2410c] px-5 py-3 text-xs font-black hover:bg-[#a9370a] cursor-pointer"
                  >
            ...
            <div className="mx-auto max-w-[1500px] px-4 py-5 md:px-6">
              <div className="mb-4 flex items-center justify-between bg-white border border-stone-200 p-3.5 rounded-2xl shadow-xs">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button onClick={resetGame} className="rounded-lg border border-stone-200 p-1.5 text-stone-500 hover:bg-stone-100 cursor-pointer" title="Restart">
                    <X className="size-4" />
                  </button>
                </div>
              </div>
