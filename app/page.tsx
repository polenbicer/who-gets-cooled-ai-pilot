        ...
        <div className="mx-auto max-w-[1400px] px-5 py-8 md:px-8 md:py-10">
          ...
          <section className="mb-8 grid gap-6 xl:grid-cols-[minmax(0,1fr)_380px] xl:items-end">
            <div className="max-w-3xl">
              ...
              {/* Professional Terracotta Play as Mayor Button */}
              <div className="mt-5">
                <Link
                  href="/sandbox"
                  className="inline-flex items-center gap-2 px-6 py-3 font-bold text-white rounded-xl bg-[#c2410c] hover:bg-[#a9370a] shadow-md transition-all text-xs"
                >
                  <span>👑</span>
